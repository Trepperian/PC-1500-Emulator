...
pub enum PhysicalKey {
    ...
    // Function keys - Solo F5 y F6 en PC-1500 real
    F5, F6,
    ...
    // Additional PC-1500 specific keys
    Exclamation, Quote, Hash, Dollar, On, Ac,
}
...
impl Pc1500KeyMapper {
    ...
    pub fn map_physical_to_pc1500(&self, key: PhysicalKey) -> Option<Pc1500Key> {
        match key {
            ...
            // Function keys - Solo F5 y F6 disponibles
            ...
            // Additional PC-1500 specific keys
            PhysicalKey::Exclamation => Some(Pc1500Key::Exclamation),
            PhysicalKey::Quote => Some(Pc1500Key::Quote),
            PhysicalKey::Hash => Some(Pc1500Key::Hash),
            PhysicalKey::Dollar => Some(Pc1500Key::Dollar),
            PhysicalKey::On => Some(Pc1500Key::On),
            PhysicalKey::Ac => Some(Pc1500Key::Ac),
        }
    }
    ...
    pub fn get_help_text() -> &'static str {
        "PC-1500 Keyboard Mappings:\n\
         ...
         Space → SPACE\n\
         Enter → ENTER\n\
         F5-F6 → F5-F6 (F1-F4 no disponibles en PC-1500 real)\n\
         +/= → Plus\n\
         - → Minus\n\
         = → Equals\n\
         . → Dot\n\
