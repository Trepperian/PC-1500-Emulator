...
impl Lh5801Cpu {
    ...
    pub(super) fn atp(&mut self, memory: &mut crate::memory::MemoryBus) -> u8 {
    ...
    pub(super) fn ita(&mut self, memory: &mut crate::memory::MemoryBus) -> u8 {
    ...
    pub(super) fn am0(&mut self, _memory: &mut crate::memory::MemoryBus) -> u8 {
    ...
    pub(super) fn am1(&mut self, _memory: &mut crate::memory::MemoryBus) -> u8 {
        // Transfer accumulator to timer register (low 8 bits)
        self.timer_register = (self.timer_register & 0xFF00) | (self.a as u16);
